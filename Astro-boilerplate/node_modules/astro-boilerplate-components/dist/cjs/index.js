...
const NavMenuItem = (props) => (jsxRuntime.jsx("li", { className: "hover:text-white", children: jsxRuntime.jsx("a", { href: props.href, children: props.children }) }));
...
const PostContent = (props) => (jsxRuntime.jsxs("div", { className: "mx-auto mt-5 max-w-prose", children: [jsxRuntime.jsx("div", { className: "aspect-w-3 aspect-h-2", children: jsxRuntime.jsx("img", { className: "h-full w-full rounded-lg object-cover object-center", src: props.content.imgSrc, alt: props.content.imgAlt, loading: "lazy" }) }), jsxRuntime.jsx("div", { className: "prose prose-invert mt-8 prose-img:rounded-lg", children: props.children })] }));
