...
var require_cookies = __commonJS({
  "node_modules/nodemailer/lib/fetch/cookies.js"(exports, module) {
    "use strict";
    var urllib = (init_url(), __toCommonJS(url_exports));
...
var require_fetch = __commonJS({
  "node_modules/nodemailer/lib/fetch/index.js"(exports, module) {
    ...
    var PassThrough = (init_stream(), __toCommonJS(stream_exports)).PassThrough;
...
var init_dns = __esm({
  "browser-external:dns"() {
    dns_default = new Proxy({}, {
      get() {
        throw new Error('Module "dns" has been externalized for browser compatibility and cannot be accessed in client code.');
      }
    });
  }
});
...
var require_smtp_connection = __commonJS({
  "node_modules/nodemailer/lib/smtp-connection/index.js"(exports, module) {
    ...
    var EventEmitter = (init_events(), __toCommonJS(events_exports)).EventEmitter;
    var net = (init_net(), __toCommonJS(net_exports));
    var tls = (init_tls(), __toCommonJS(tls_exports));
    var os = (init_os(), __toCommonJS(os_exports));
    var crypto = (init_crypto(), __toCommonJS(crypto_exports));
...
// dep:nodemailer
var nodemailer_default = require_nodemailer();
export {
